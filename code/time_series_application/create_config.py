def create_config(cloud=False):
    ...
    if cloud:
        # Define Path
        config['base_path_hadoop'] = '/home/hadoop/code/time_series_application/'
        config['base_path_data'] = 's3://data-folders/spark_parallel_forecasting/'
        config['path_training_data_csv'] = config['base_path_data'] + 'training_data/csv/rawdata_small.csv'
